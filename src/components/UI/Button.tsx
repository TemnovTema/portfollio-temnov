...
export const BUTTON_VARIANTS = {
  DEFAULT: cn('group w-fit px-4 py-3 flex items-center justify-center border rounded-lg duration-300', 'font-mono font-semibold uppercase'),
...
export const BUTTON_SIZES = {
  ...
  small: cn('px-3.5 py-3 mob:px-3 mob:py-2.5', 'gap-1.5', 'text-sm tracking-wide'),
}
