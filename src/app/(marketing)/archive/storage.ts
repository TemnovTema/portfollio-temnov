...
export const ITEMS: SocialsItem[] = [
  ...
  },
  {
    ...
    image: '/cases/vibecode/neural-eclipse/cover.png',
    link: '/archive/case-14',
    content: [
      'Редакционный веб-лонгрид о границе между нейросетевой генерацией текста и самостоятельным философским мышлением.',
      'Крупная типографика, цитаты, сравнительные блоки и образная графика превращают философское эссе в последовательный цифровой рассказ.',
    ],
  },
]
